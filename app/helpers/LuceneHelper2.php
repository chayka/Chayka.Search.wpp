...
class LuceneHelper2 {
    ...
    public static function initAnalyzer(){
        ...
        if(!($analyzer instanceof Analyzer2)){

            try {
                Lucene\Search\QueryParser::setDefaultEncoding('utf-8');
                $analyzer = new Analyzer2();
     ...
     *
     * @return MorphyFilter2
     */
    public static function getMorphy(){
        if(!self::$morphy){
            self::$morphy = new MorphyFilter2();
        }
        return self::$morphy;
    }
...
class Analyzer2 extends Lucene\Analysis\Analyzer\Common\Utf8\CaseInsensitive{
    /**
...
class MorphyFilter2 extends Lucene\Analysis\TokenFilter\LowerCaseUtf8 {
